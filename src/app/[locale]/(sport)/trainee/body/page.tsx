...
import { AthleteProgressPdf } from "@/components/sport/athlete-progress-pdf";
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-6">
      <div className="mb-6 flex items-center justify-between gap-3">
        ...
        <AthleteProgressPdf className="rounded-lg border-emerald-200 text-emerald-700 hover:bg-emerald-50" />
      </div>
