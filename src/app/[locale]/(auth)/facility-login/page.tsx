...
/**
 * Facility / Hospital Login Page
 *
 * Allows hospital administrators to access the facility management portal.
    ...
    <Card className="overflow-hidden">
      <CardContent className="p-8 sm:p-10">
        ...
        <div className="mb-8 flex flex-col items-center text-center">
          <div className="mb-4 grid size-16 place-items-center rounded-2xl bg-pink-500/10 text-pink-600">
