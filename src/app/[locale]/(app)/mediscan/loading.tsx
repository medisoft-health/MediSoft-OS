...
/**
 * MediScan skeleton — matches breadcrumb + header + 4 KPI cards + hero CTA +
 * recent scans table layout.
 */
export default function MediScanLoading() {
  return (
