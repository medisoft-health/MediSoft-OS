          ...
          <div className="flex h-full items-center justify-center">
            <div className="max-w-md text-center">
              ...
              <div className="mb-6 grid grid-cols-2 gap-3 text-left text-xs">
                <Feature icon={MessageCircle} text="Structured OPQRST Interview" />
                <Feature icon={FileText} text="Auto-generated Summary" />
                <Feature icon={Globe} text="Arabic & English" />
                <Feature icon={Sparkles} text="AI Risk Assessment" />
              </div>
              <button
        ...
        <div className="border-t border-[color:var(--color-border)] bg-green-500/5 p-4">
          <div className="mx-auto max-w-2xl">
            <div className="mb-3 flex items-center gap-2 text-sm font-semibold text-green-700">
              ...
              Interview Complete — Physician Summary Generated
            </div>
            <div className="grid gap-3 text-xs md:grid-cols-3">
              <div className="rounded-lg bg-white/80 p-3 dark:bg-black/20">
                <div className="mb-1 font-semibold">Chief Complaint</div>
                <div className="text-[color:var(--color-muted-foreground)]">
                  {summary.chiefComplaint}
                </div>
              </div>
              <div className="rounded-lg bg-white/80 p-3 dark:bg-black/20">
                <div className="mb-1 font-semibold">Urgency</div>
              ...
              <div className="rounded-lg bg-white/80 p-3 dark:bg-black/20">
                <div className="mb-1 font-semibold">Completeness</div>
                <div className="text-[color:var(--color-muted-foreground)]">
